package com.example.android.scantest.engine;
 ...
 */
public final class QrByteWriter {

  private static final int QUIET_ZONE_SIZE = 4;

  public ByteMatrix encode(byte[] contents, BarcodeFormat format, int width, int height) throws WriterException {
...
//TODO Error Correction Level set-up
    ErrorCorrectionLevel errorCorrectionLevel = ErrorCorrectionLevel.L;

    QRCode code = new QRCode();
    QrByteEncoder.encode(contents, errorCorrectionLevel, code);
